"""torchrun --standalone --nproc-per-node <N> examples/train_ddp.py

Trains TinyGPT on synthetic token sequences using the from-scratch
DistributedDataParallel implementation in zerodp.ddp.
"""
import torch
...
def main() -> None:
    ...
    model = DistributedDataParallel(model, bucket_size_mb=10.0)
